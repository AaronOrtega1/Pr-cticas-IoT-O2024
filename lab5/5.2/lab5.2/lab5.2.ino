...
const char *ssid = "INFINITUM5AA2_2.4";
const char *password = "Dvz2vfXKF7";
WiFiClient  client;

// OpenWeather
String apiTemperature;
String serverPath = "http://api.openweathermap.org/data/2.5/weather?lat=20&lon=-103&appid=63d312173bd97d824214316955359923&units=metric"; //API KEY OpenWeather


// ThingSpeak
uint32_t channelNumber = 2720868;
const char *writeAPIKey = "D7R8FT8O3SFZWSZA";
...
void sendDataToThingSpeak(){
    ...
    int code = ThingSpeak.writeFields(2720868, "D7R8FT8O3SFZWSZA");
    if(code == 200)
