...
// Código clase IoT - Francisco Aarón Ortega Anguiano y Jose Antonio Mendoza Navarro
...
#define TARGET_DEVICE_NAME "ESPJOSE"  // Cambiar según el nombre del emisor configurado
...
const float TEMP_THRESHOLD = 22;  // Cambiar según el umbral deseado
// ===============================================
